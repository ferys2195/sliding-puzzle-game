...
export default function Footer() {
  return (
    ...
    >
      <p className="mt-1">
        Made with <span className="text-red-700">❤</span> by Fery Irawan
      </p>
      <p>
        This project is open source, visit{" "}
        <a
          href="https://github.com/ferys2195/sliding-puzzle-game"
          target="_blank"
          className="underline"
        >
          the repo.
      ...
      <div className="mt-2.5 flex items-center justify-center gap-1.5">
        <a href="https://github.com/ferys2195" className="hover:text-black/80">
          <svg
        ...
        <a
          href="https://www.linkedin.com/in/ferys2195/"
        ...
        <a
          href="https://facebook.com/ferys2195"
          className="hover:text-black/80"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          href="https://instagram.com/ferys2195"
          className="hover:text-black/80"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
